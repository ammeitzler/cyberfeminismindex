...
class IconBlock(ChoiceBlock):
    ...
    class Meta:
        ...
        template = 'wagtailfontawesome/blocks/icon.html'
        help_text = 'Select the name of an icon to use. It will be shown as an icon on the rendered page.'
